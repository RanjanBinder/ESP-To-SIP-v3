// PIM Review — Tracks · mock extraction data
// Simulated output of the ESP asset-extraction engine for Nellore (NLR) yard.
// Drawing units are metres; the SVG viewBox is 0 0 1600 780 so 1 unit = 1 m.
//
// Nothing here talks to a backend. The screen mutates copies of these records.
...
(() => {
  ...
  // ── Drawing layers (source CAD layers exposed to the layer control) ────────
  const LAYERS = [
  ...
  // ── Track assets identified by the engine ─────────────────────────────────
  // segmentIds point at SEGMENTS below. confidenceScore is 0-100.
  const TRACKS = [
    {
      id: "TRK-001", name: "UP Main Line", roadNumber: "1", trackType: "Main Line",
      operationalStatus: "Existing", trafficDirection: "UP",
      passengerGoods: "Passenger", berthingTrack: true,
      segmentIds: ["SEG-101", "SEG-102", "SEG-103"],
      startNodeId: "ND-W1", endNodeId: "ND-E1",
      startChainage: "431.240", endChainage: "432.720", length: 1480,
      sourceType: "AI Auto-Mapped", confidenceScore: 94, validationStatus: "Ready for Confirmation",
      curvature: "Straight",
      connectedTracks: ["TRK-003"], connectedTurnouts: ["P-101", "P-118"],
      associatedPlatform: "PF 1", deadEnd: false, bufferStop: false, foulingMarks: 2,
    },
    {
      id: "TRK-002", name: "DOWN Main Line", roadNumber: "2", trackType: "Main Line",
      operationalStatus: "Existing", trafficDirection: "DOWN",
      passengerGoods: "Passenger", berthingTrack: true,
      segmentIds: ["SEG-104", "SEG-105"],
      startNodeId: "ND-W2", endNodeId: "ND-E2",
      startChainage: "431.240", endChainage: "432.720", length: 1480,
      sourceType: "AI Auto-Mapped", confidenceScore: 92, validationStatus: "Ready for Confirmation",
      curvature: "Straight",
      connectedTracks: ["TRK-005"], connectedTurnouts: ["P-104", "P-122"],
      associatedPlatform: "PF 2", deadEnd: false, bufferStop: false, foulingMarks: 2,
    },
    {
      id: "TRK-003", name: "Road No. 1", roadNumber: "3", trackType: "Loop Line",
      operationalStatus: "Existing", trafficDirection: "Bidirectional",
      passengerGoods: "Passenger", berthingTrack: true,
      segmentIds: ["SEG-106", "SEG-107", "SEG-108"],
      startNodeId: "ND-P101", endNodeId: "ND-P118",
      startChainage: "431.480", endChainage: "432.452", length: 1008,
      sourceType: "AI Auto-Mapped", confidenceScore: 88, validationStatus: "Ready for Confirmation",
      curvature: "Curved",
      connectedTracks: ["TRK-001", "TRK-004"], connectedTurnouts: ["P-101", "P-118"],
      associatedPlatform: "PF 1", deadEnd: false, bufferStop: false, foulingMarks: 2,
    },
    {
      id: "TRK-004", name: "Road No. 2", roadNumber: "4", trackType: "Loop Line",
      operationalStatus: "Existing", trafficDirection: "Bidirectional",
      passengerGoods: "Goods", berthingTrack: false,
      segmentIds: ["SEG-109", "SEG-110"],
      startNodeId: "ND-P106", endNodeId: null,
      startChainage: "431.650", endChainage: "432.180", length: 546,
      sourceType: "AI Auto-Mapped", confidenceScore: 76, validationStatus: "Needs Review",
      curvature: "Curved",
      connectedTracks: ["TRK-003"], connectedTurnouts: ["P-106"],
      associatedPlatform: "—", deadEnd: false, bufferStop: false, foulingMarks: 1,
    },
    {
      id: "TRK-005", name: "Goods Line", roadNumber: "5", trackType: "Goods Line",
      operationalStatus: "Existing", trafficDirection: "Bidirectional",
      passengerGoods: "Goods", berthingTrack: false,
      segmentIds: ["SEG-111", "SEG-112", "SEG-113"],
      startNodeId: "ND-P104", endNodeId: "ND-P122",
      startChainage: "431.560", endChainage: "432.442", length: 918,
      sourceType: "AI Auto-Mapped", confidenceScore: 90, validationStatus: "Ready for Confirmation",
      curvature: "Curved",
      connectedTracks: ["TRK-002"], connectedTurnouts: ["P-104", "P-122"],
      associatedPlatform: "PF 2", deadEnd: false, bufferStop: false, foulingMarks: 2,
    },
    {
      id: "TRK-006", name: "Pit Line", roadNumber: "6", trackType: "Pit Line",
      operationalStatus: "Existing", trafficDirection: "Not Applicable",
      passengerGoods: "Not Applicable", berthingTrack: false,
      segmentIds: ["SEG-114", "SEG-115"],
      startNodeId: "ND-P112", endNodeId: "ND-BS1",
      startChainage: "431.840", endChainage: "432.358", length: 518,
      sourceType: "AI Auto-Mapped", confidenceScore: 84, validationStatus: "Ready for Confirmation",
      curvature: "Curved",
      connectedTracks: ["TRK-005"], connectedTurnouts: ["P-112"],
      associatedPlatform: "—", deadEnd: true, bufferStop: true, foulingMarks: 1,
    },
    // ── Needs review ───────────────────────────────────────────────────────
    {
      id: "TRK-007", name: "", roadNumber: "", trackType: "Shunting Neck",
      operationalStatus: "Existing", trafficDirection: "Not Applicable",
      passengerGoods: "Not Applicable", berthingTrack: false,
      segmentIds: ["SEG-116", "SEG-117"],
      startNodeId: "ND-P116", endNodeId: null,
      startChainage: "432.020", endChainage: "432.358", length: 338,
      sourceType: "AI Auto-Mapped", confidenceScore: 58, validationStatus: "Needs Review",
      curvature: "Curved",
      connectedTracks: ["TRK-006"], connectedTurnouts: ["P-116"],
      associatedPlatform: "—", deadEnd: false, bufferStop: false, foulingMarks: 0,
      review: {
    ...
    {
      id: "TRK-008", name: "Sick Line (unconfirmed)", roadNumber: "", trackType: "Other",
      operationalStatus: "Existing", trafficDirection: "Not Applicable",
      passengerGoods: "Not Applicable", berthingTrack: false,
      segmentIds: ["SEG-118", "SEG-119", "SEG-120"],
      startNodeId: "ND-W8", endNodeId: "ND-P106",
      startChainage: "431.140", endChainage: "431.652", length: 508,
      sourceType: "AI Auto-Mapped", confidenceScore: 61, validationStatus: "Validation Failed",
      curvature: "Curved",
      connectedTracks: ["TRK-004"], connectedTurnouts: ["P-106"],
      associatedPlatform: "—", deadEnd: true, bufferStop: true, foulingMarks: 0,
      review: {
  ...
  // ── Every drawn geometry piece on the source ESP ───────────────────────────
  // trackId === null → unidentified. groupId clusters unidentified elements
  // into the review items shown on the Unidentified tab.
  const SEGMENTS = [
    ...
    { id: "SEG-110", trackId: "TRK-004", layer: "TRACK", sourceLayer: "0-TRACK-CL", geometryType: "Line", d: "M582 200 H1000", start: [582, 200], end: [1000, 200], length: 418 },
    ...
    { id: "ELM-201", trackId: null, groupId: "G-201", layer: "UNIDENTIFIED", sourceLayer: "0-UNCLASSIFIED", geometryType: "Line", d: "M1000 200 H1090", start: [1000, 200], end: [1090, 200], length: 90 },
    ...
    { id: "ELM-206", trackId: null, groupId: "G-203", layer: "UNIDENTIFIED", sourceLayer: "DIM-LINEAR", geometryType: "Line", d: "M300 700 H1300", start: [300, 700], end: [1300, 700], length: 1000 },
  ...
  // ── Review metadata for each unidentified group ────────────────────────────
  const ELEMENT_GROUPS = [
    {
      id: "G-201", label: "Curved run east of Road No. 2",
      elementIds: ["ELM-201", "ELM-202", "ELM-203"],
      aiClassification: "Unclassified linear geometry", aiConfidence: 41,
      nearestTrackId: "TRK-004", nearestDistance: "0.0 m (touching)",
      suggestedAction: "map", suggestedTrackId: "TRK-004",
      suggestionReason: "Aligned and connected to the open east end of Road No. 2.",
      status: "Unidentified",
    },
    {
      id: "G-202", label: "West run below DOWN Main",
      elementIds: ["ELM-204", "ELM-205"],
      aiClassification: "Unclassified linear geometry", aiConfidence: 38,
      nearestTrackId: "TRK-005", nearestDistance: "0.0 m (touching)",
      suggestedAction: "map", suggestedTrackId: "TRK-005",
      suggestionReason: "Collinear with the Goods Line and touching its west start node.",
      status: "Unidentified",
    },
    {
      id: "G-203", label: "Long horizontal line below yard",
      elementIds: ["ELM-206"],
      aiClassification: "Possible dimension line", aiConfidence: 22,
      nearestTrackId: "TRK-007", nearestDistance: "114 m",
      suggestedAction: "reject", suggestedReason: "Dimension line",
      suggestionReason: "Drawn on DIM-LINEAR with witness ticks at both ends and a 1000.00 annotation.",
      status: "Unidentified",
    },
    {
      id: "G-204", label: "Parallel pair beside Platform 1",
      elementIds: ["ELM-207", "ELM-208"],
      aiClassification: "Possible platform boundary", aiConfidence: 27,
      nearestTrackId: "TRK-001", nearestDistance: "14 m",
      suggestedAction: "reject", suggestedReason: "Platform boundary",
      suggestionReason: "Drawn on PLATFORM-EDGE, 24 m apart, bounding the Platform 1 hatch.",
      status: "Unidentified",
    },
    {
      id: "G-205", label: "Disconnected stub east of shunting neck",
      elementIds: ["ELM-209", "ELM-210"],
      aiClassification: "Unclassified linear geometry", aiConfidence: 44,
      nearestTrackId: "TRK-007", nearestDistance: "50 m",
      suggestedAction: "create", suggestedTrackType: "Sick Line",
      suggestionReason: "On the shunting neck alignment but separated by a 50 m gap; contains an internal 2.4 m gap.",
      status: "Unidentified",
    },
  ];

  // ── Turnouts / nodes drawn as decoration on the TRACK layer ────────────────
  const TURNOUTS = [
    { id: "P-101", x: 300, y: 330 }, { id: "P-118", x: 1272, y: 330 },
    { id: "P-104", x: 380, y: 386 }, { id: "P-122", x: 1262, y: 386 },
    { id: "P-106", x: 470, y: 262 }, { id: "P-112", x: 660, y: 452 },
  ...
  // ── Non-selectable drawing furniture ──────────────────────────────────────
  const PLATFORMS = [
  ...
  // ── Seeded validation findings (2 errors, 3 warnings, 1 information) ───────
  const SEED_VALIDATIONS = [
    {
      id: "V-E1", severity: "error", category: "Geometry", trackId: "TRK-008",
    ...
    {
      id: "V-E2", severity: "error", category: "Mandatory Attributes", trackId: "TRK-007",
    ...
    {
      id: "V-W1", severity: "warning", category: "Connectivity", trackId: "TRK-004",
    ...
    {
      id: "V-W2", severity: "warning", category: "Geometry", groupId: "G-205",
    ...
    {
      id: "V-W3", severity: "warning", category: "Duplicate Mapping", trackId: "TRK-006",
    ...
    {
      id: "V-I1", severity: "information", category: "Track Naming",
  ...
  // ── Option lists (aligned with the Station Hub track review form) ─────────
